# PinchBot Channel System: Complete Development Guide
...
import (
    "github.com/sipeed/pinchbot/pkg/bus"
    "github.com/sipeed/pinchbot/pkg/channels"     // Reference parent package
    "github.com/sipeed/pinchbot/pkg/config"
    "github.com/sipeed/pinchbot/pkg/identity"      // New
    "github.com/sipeed/pinchbot/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "github.com/sipeed/pinchbot/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/sipeed/pinchbot/pkg/channels/discord"
    _ "github.com/sipeed/pinchbot/pkg/channels/your_new_channel"  // New addition
)
```
...
import (
    ...
    "github.com/sipeed/pinchbot/pkg/channels"
    "github.com/sipeed/pinchbot/pkg/config"
    "github.com/sipeed/pinchbot/pkg/identity"
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom PinchBot native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
