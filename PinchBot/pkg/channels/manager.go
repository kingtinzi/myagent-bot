...
// RegisterHandler registers an extra HTTP handler on the shared mux (e.g. /usage, /dashboard).
// Must be called after SetupHTTPServer.
func (m *Manager) RegisterHandler(pattern string, handler http.Handler) {
	if m.mux != nil {
