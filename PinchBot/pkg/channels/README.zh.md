# PinchBot Channel System：完整开发指南
...
import (
    "github.com/sipeed/pinchbot/pkg/bus"
    "github.com/sipeed/pinchbot/pkg/channels"     // 引用父包
    "github.com/sipeed/pinchbot/pkg/config"
    "github.com/sipeed/pinchbot/pkg/identity"      // 新增
    "github.com/sipeed/pinchbot/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/sipeed/pinchbot/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/sipeed/pinchbot/pkg/channels/discord"
    _ "github.com/sipeed/pinchbot/pkg/channels/your_new_channel"  // 新增
)
```
...
4. **Pico Protocol**：`pkg/channels/pico/` 实现了一个自定义的 PinchBot 原生协议 channel，通过 WebSocket webhook (`/pico/ws`) 接收消息。
