...
func (c *FeishuChannel) Send(ctx context.Context, msg bus.OutboundMessage) error {
	...
	// First attempt: interactive card.
	...
	// Other card errors are returned as-is.
	return err
}
...
func (c *FeishuChannel) downloadResource(
	...
	// Write to the shared PinchBot_media directory using a unique name to avoid collisions.
	mediaDir := filepath.Join(os.TempDir(), "PinchBot_media")
