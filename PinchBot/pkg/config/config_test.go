...
func TestDefaultConfig_WorkspacePath_Default(t *testing.T) {
	...
	cfg := DefaultConfig()
	want := filepath.Join("/tmp/home", ".PinchBot", "workspace")
...
func TestDefaultConfig_WorkspacePath_WithPinchBotHome(t *testing.T) {
	t.Setenv("PinchBot_HOME", "/custom/PinchBot/home")

	cfg := DefaultConfig()
	want := "/custom/PinchBot/home/workspace"

	if cfg.Agents.Defaults.Workspace != want {
		t.Errorf("Workspace path with PinchBot_HOME = %q, want %q", cfg.Agents.Defaults.Workspace, want)
	}
}
