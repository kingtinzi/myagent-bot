...
// DefaultConfig returns the default configuration for PinchBot.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: ${PINCHBOT_HOME} > ~/.pinchbot
	var homePath string
	if PinchBotHome := os.Getenv("PINCHBOT_HOME"); PinchBotHome != "" {
		homePath = PinchBotHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".pinchbot")
	}
