...
func createClaudeAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for anthropic. Run: PinchBot auth login --provider anthropic")
	}
...
func createCodexAuthProvider() (LLMProvider, error) {
	...
	if cred == nil {
		return nil, fmt.Errorf("no credentials for openai. Run: PinchBot auth login --provider openai")
	}
...
// Supported protocols: openai, litellm, anthropic, antigravity, claude-cli, codex-cli, github-copilot, official
...
func CreateProviderFromConfig(cfg *config.ModelConfig) (LLMProvider, string, error) {
	...
	case "official":
		return NewOfficialProvider(cfg.APIBase), modelID, nil
