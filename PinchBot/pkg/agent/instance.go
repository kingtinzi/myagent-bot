...
func NewAgentInstance(
	...
	if cfg.Tools.IsToolEnabled("exec") {
		...
		if err != nil {
			log.Printf("Warning: unable to initialize exec tool; continuing without exec: %v", err)
		} else {
	...
	if defaults.ToolModel != "" && cfg != nil {
		...
		if err == nil && mc != nil {
			...
			if err == nil && toolProv != nil {
				...
				resolved := resolveModelCandidates(cfg, defaults.Provider, defaults.ToolModel, nil)
				if len(resolved) > 0 {
