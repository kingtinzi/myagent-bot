...
func TestGetConfigPath(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join("/tmp/home", ".PinchBot", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithPinchBot_HOME(t *testing.T) {
	t.Setenv("PinchBot_HOME", "/custom/PinchBot")
	t.Setenv("HOME", "/tmp/home")

	got := GetConfigPath()
	want := filepath.Join("/custom/PinchBot", "config.json")

	assert.Equal(t, want, got)
}

func TestGetConfigPath_WithPinchBot_CONFIG(t *testing.T) {
	t.Setenv("PinchBot_CONFIG", "/custom/config.json")
	t.Setenv("PinchBot_HOME", "/custom/PinchBot")
	t.Setenv("HOME", "/tmp/home")
...
func TestGetConfigPath_Windows(t *testing.T) {
	...
	got := GetConfigPath()
	want := filepath.Join(testUserProfilePath, ".PinchBot", "config.json")
